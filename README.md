...
One natural idea is to train a deep neural network (e.g., a U-Net) to predict fluorescent images directly from transmitted-light images. However, this approach has critical limitations:
